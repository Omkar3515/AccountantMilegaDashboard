    ...
    <div className="grid grid-cols-1 xl:grid-cols-[1.8fr_.95fr] gap-5 mt-7">
        ...
        <aside className="space-y-5">
            ...
            <section className="resume-card bg-white border border-slate-200 rounded-xl p-5"><h2 className="font-bold">Quick Actions</h2>
                ...
                <button className="w-full mt-5 text-left bg-red-50 border border-red-100 text-red-600 rounded-lg p-3 text-sm font-semibold hover:bg-red-100 transition-colors">
  <div className="flex items-center gap-2">
    <Trash2 className="w-4 h-4 flex-shrink-0" />
    <div>
      <div>Delete Resume</div>
      <p className="text-[10px] font-normal mt-1 text-red-500">
